...
use Lovata\PropertiesShopaholic\Classes\Event\MeasureModelHandler;
//Offer event list
    ...
    public function registerSettings()
    {
        return [
            ...
            'shopaholic-menu-measure'      => [
                'label'       => 'lovata.propertiesshopaholic::lang.menu.measure',
                'description' => 'lovata.propertiesshopaholic::lang.menu.measure_description',
                'category'    => 'lovata.shopaholic::lang.tab.settings',
                'url'         => Backend::url('lovata/propertiesshopaholic/measures'),
