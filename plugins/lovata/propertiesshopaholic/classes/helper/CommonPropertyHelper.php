...
class CommonPropertyHelper
{
    ...
    protected function processPropertyValue($iPropertyID, $sValue)
    {
        ...
        $obPropertyValue = $this->getValueObject($sValue, $iPropertyID);
     ...
     */
    protected function getValueObject($sValue, $iPropertyID)
    {
        ...
        foreach (array_keys($arActiveLangList) as $sLangCode) {
            ...
            $sLangValue = Input::get('RLTranslate.'.$sLangCode.'.property.'.$iPropertyID);
            if (!empty($sLangValue)) {
