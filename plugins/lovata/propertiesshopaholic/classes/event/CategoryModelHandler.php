...
class CategoryModelHandler
{
    ...
    protected function extendCategoryItem($obItem)
    {
        ...
        $obItem->addDynamicMethod('getPropertySetAttribute', function () use ($obItem) {
        ...
        $obItem->addDynamicMethod('getProductPropertyListAttribute', function () use ($obItem) {
        ...
        $obItem->addDynamicMethod('getOfferPropertyListAttribute', function () use ($obItem) {
